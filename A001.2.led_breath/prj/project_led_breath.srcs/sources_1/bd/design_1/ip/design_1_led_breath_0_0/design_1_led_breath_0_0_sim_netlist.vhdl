...
architecture STRUCTURE of design_1_led_breath_0_0_led_breath is
  ...
  signal \cnt_1ms[5]_i_3_n_0\ : STD_LOGIC;
  ...
  signal \cnt_1us[6]_i_2_n_0\ : STD_LOGIC;
  signal \cnt_1us[9]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \cnt[6]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \cnt_1ms[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \cnt_1ms[2]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \cnt_1ms[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \cnt_1ms[5]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \cnt_1ms[5]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \cnt_1ms[7]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \cnt_1ms[8]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \cnt_1ms[9]_i_3\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \cnt_1ms[9]_i_7\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \cnt_1us[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \cnt_1us[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \cnt_1us[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \cnt_1us[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \cnt_1us[6]_i_2\ : label is "soft_lutpair7";
...
\cnt_1ms[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\cnt_1ms[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\cnt_1ms[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\cnt_1ms[4]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B4"
    )
        port map (
...
\cnt_1ms[5]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\cnt_1ms[5]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\cnt_1ms[8]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\cnt_1ms[9]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00DF0020"
    )
        port map (
...
\cnt_1ms[9]_i_6\: unisim.vcomponents.LUT6
    generic map(
...
\cnt_1ms[9]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\cnt_1us[6]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\cnt_1us[9]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\cnt_1us[9]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\cnt_1us[9]_i_6\: unisim.vcomponents.LUT6
    generic map(
