...
set app0Name app
 puts "hw is $projpath/$xsaName.xsa"
#Create a new platform
#platform create -name $xsaName -hw $projpath/$xsaName.xsa -proc {ps7_cortexa9_0} -os {standalone}   -out $projpath
platform create -name $xsaName -hw $projpath/$xsaName.xsa -proc {ps7_cortexa9_0} -os {freertos10_xilinx}   -out $projpath
...
app create -name $app0Name -platform $xsaName -domain freertos10_xilinx_domain -template "FreeRTOS Hello World"
