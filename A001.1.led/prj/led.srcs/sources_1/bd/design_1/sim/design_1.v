...
module design_1
  ...
  assign led_0[3:0] = io_change_0_led;
  design_1_io_change_0_0 io_change_0
       (.led(io_change_0_led),
        .s_rst(processing_system7_0_FCLK_RESET0_N),
        .sclk(processing_system7_0_FCLK_CLK0));
